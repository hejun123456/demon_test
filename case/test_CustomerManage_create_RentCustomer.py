...
#读取出excel中的测试数据
testdata = readexcel.ExcelUtil(CUSTOMER_MANAGE_EXCEL_PATH,sheetName="客源管理-求租-登记").dict_data()
print(testdata)

@ddt.ddt
class CustomerManage_RentCustomer(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # 如果有登录的话，就在这里先登录了
    ...
    @ddt.data(*testdata)
    def test_create_rentCustomer(self, case):
